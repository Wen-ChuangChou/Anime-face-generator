...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        self.ds = Dataset(folder, self.image_size,
                          augment_horizontal_flip=augment_horizontal_flip, convert_image_to=convert_image_to)
    ...
    def fid_score(self, real_samples, fake_samples):
        ...
        if self.channels == 1:
            real_samples, fake_samples = map(lambda t: repeat(
                t, 'b 1 ... -> b c ...', c=3), (real_samples, fake_samples))
